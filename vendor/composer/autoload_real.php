...
class ComposerAutoloaderInitab19d04ac42e6df2196f98f38bd86a0f
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitab19d04ac42e6df2196f98f38bd86a0f::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequireab19d04ac42e6df2196f98f38bd86a0f($fileIdentifier, $file);
        }
...
function composerRequireab19d04ac42e6df2196f98f38bd86a0f($fileIdentifier, $file)
{
