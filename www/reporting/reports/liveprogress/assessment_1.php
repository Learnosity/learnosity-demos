...
$request = array(
    ...
    'config'         => array(
        ...
        'assessApiVersion'    => 'v2',
        'configuration'       => array(
            'ondiscard_redirect_url' => './assessment_1.php?user_id=' . $_GET['user_id'],
            'onsubmit_redirect_url' => './assessment_1.php?user_id=' . $_GET['user_id'],
            'onsave_redirect_url'   => './assessment_1.php?user_id=' . $_GET['user_id'],
            'events'                => true
        )
    )
);
