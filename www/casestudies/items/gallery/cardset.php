    ...
    <section class="gallery">
        <div class="row">
            ...
            <div class="col-md-4 pod">
                <div class="effect2">
                    <div class="card" data-activity="<?php echo $activityRef; ?>">
...
<script>
    ...
    function init () {
        $('.card').on('click', function (el) {
            var activityRef = $(this).attr('data-activity');
            var itemRef = $(this).find('div.learnosity-item').attr('data-reference');
            loadActivity(activityRef, itemRef);
        });
    }

    function loadActivity(activityRef, itemRef) {
        location.href = 'card.php?set=' + activityRef + '&ref=' + itemRef;
    }
</script>
