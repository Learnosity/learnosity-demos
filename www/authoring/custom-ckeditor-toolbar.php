...
?>
    ...
    <div class="jumbotron section">
        ...
        <div class="overview">
            ...
            <img src="../static/images/ckeditor-default-toolbar.png" height=90% width=90%></p>
            <p>In this demo, we have customized the toolbar to only show seven buttons, like so:<br> <img src="../static/images/ckeditor-customized-toolbar.png"  height=20% width=20%></p>
