    ...
    <div class="jumbotron section">
        ...
        <div class="overview">
            ...
            <p>The item list mode allows users to choose and select multiple items. This is particularly useful when building an item picker as part of a larger solution.<br>
                Your application can then get the array of selected items using the <a href="https://reference.learnosity.com/methods/authorApp/getSelectedItems">getSelectedItems()</a> method.</p>
        </div>
    </div>
