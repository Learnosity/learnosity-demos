    ...
    <div class="section index">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Browse Items in Your Item Bank</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Browse Activities in Your Item Bank</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Filter Items in Your Item Bank</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Filter Activities in Your Item Bank</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Preview your Item Bank in Read-Only Mode</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Select Multiple Items from Item Browsing</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Browse Items Using Tag Hierarchies</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Control which Tags Appear in the Authoring Interface</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Navigate your Item Bank</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Bind to Author API Events</h3>
                </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create an Activity With Items From Multiple Item Banks</h3>
                    </div>
                    <div class="card-body">
    ...
    <div class="section index">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create New Activities</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Questions Directly</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Workflow States and Comments</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create Random Activity</h3>
                    </div>
                    <div class="card-body">
    ...
    <div class="section index">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Build Custom Question Templates</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Simplify Authoring for Teachers and Instructors</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Customize the Question Editing Layout</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Use your Own Digital Asset Management System</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Use Custom Editor Buttons</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Customize the Simple Feature Modal Layout</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Right-to-Left Language Support (items)</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Right-to-Left Language Support (activities)</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Customizing the RTE toolbar</h3>
                    </div>
                    <div class="card-body">
        ...
        <!-- <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Enabling Item Titles</h3>
                    </div>
                    <div class="card-body">
