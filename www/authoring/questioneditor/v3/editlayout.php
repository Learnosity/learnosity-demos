...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
            <div class="panel-body">
                <div class="lrn-qe-ui">
                    <span data-lrn-qe-label="validation" value="Correct answer:"></span>
                    <span data-lrn-qe-label="validation.valid_response.score"></span>
                    <span data-lrn-qe-input="validation.valid_response.score" class="lrn-qe-form-control-sm"></span>
                    <span data-lrn-qe-input="validation.valid_response.value"></span>

                    <div data-lrn-qe-loop="validation.alt_responses[*]">
                        <div class="lrn-divider"></div>

                        <div class="lrn-row-flex">
                            <div class="lrn-col-sm-6">
                                <span data-lrn-qe-label="validation.alt_responses[*]"></span>
                            </div>
                            <div class="lrn-col-sm-6">
                                <span data-lrn-qe-action-remove="validation.alt_responses[*]" class="lrn-float-right pts"/>
                            </div>
                        </div>
                        <span data-lrn-qe-label="validation.alt_responses[*].score"></span>
                        <span data-lrn-qe-input="validation.alt_responses[*].score" class="lrn-qe-form-control-sm"/>
                        <span data-lrn-qe-input="validation.alt_responses[*].value"></span>
                    </div>

                    <div class="lrn-divider"></div>
                    <span data-lrn-qe-action-add="validation.alt_responses"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
            <div class="panel-body">
                <div class="lrn-qe-ui">
                    ...
                    <div class="lrn-row-flex">
                        <div class="lrn-col-xs-12 lrn-col-sm-6">
                    ...
                    <div class="lrn-row-flex">
                        <div data-lrn-qe-loop="metadata.distractor_rationale_response_level[*]" class="lrn-col-xs-12 lrn-col-sm-6">
