...
<div class="jumbotron section">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Custom Short Text</h2>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Custom Mathcore</h2>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Custom Implementation</h2>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Custom Percentage Bar</h2>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Custom Box Whisker</h2>
                </div>
                <div class="card-body">
                    <p>Demonstrates the implementation of a Custom question with an interactive and more complex UI.<p>
                    <p class="text-end">
