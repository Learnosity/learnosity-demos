...
<div class="jumbotron section index">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Display Student-Centric Reports</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Present Classroom & Teacher-Centric Reports</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Show Coursework Progress</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Display Large-Scale Group/District Reports</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Response Analysis Reporting</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Analyze Learning Outcomes Report & Mastery</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Provide Live Progress Tracking & Control</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Disable Reporting UI to Work Directly with Data</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Use click events</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">View Data API Examples</h3>
                </div>
                <div class="card-body">
