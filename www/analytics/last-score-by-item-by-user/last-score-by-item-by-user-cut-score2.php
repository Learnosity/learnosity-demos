...
<style>
    ...
    .learnosity-report .lrn-report-table tr[data-custom_performance="1"] .lrn-report-user,
    .learnosity-report .lrn-report-table tr[data-custom_performance="2"] .lrn-report-user,
    .learnosity-report .lrn-report-table tr[data-custom_performance="3"] .lrn-report-user,
    .learnosity-report .lrn-report-table tr[data-custom_performance="4"] .lrn-report-user {
        font-family: 'Helvetica Neue';
        font-style: normal;
        font-weight: 700;
        font-size: 13px;
    ...
    .learnosity-report .lrn-report-table tr[data-custom_performance="1"] .lrn-report-score,
    .learnosity-report .lrn-report-table tr[data-custom_performance="2"] .lrn-report-score,
    .learnosity-report .lrn-report-table tr[data-custom_performance="3"] .lrn-report-score,
    .learnosity-report .lrn-report-table tr[data-custom_performance="4"] .lrn-report-score {
        font-family: 'Helvetica Neue';
        font-style: normal;
        font-weight: 700;
        font-size: 13px;
    }
    .learnosity-report .table-bordered tr[data-custom_performance="1"] .lrn-report-user::after,
    .learnosity-report .table-bordered tr[data-custom_performance="2"] .lrn-report-user::after,
    .learnosity-report .table-bordered tr[data-custom_performance="3"] .lrn-report-user::after,
    .learnosity-report .table-bordered tr[data-custom_performance="4"] .lrn-report-user::after {
        width: 28px;
        height: 28px;
        position: absolute;
        top: 45%;
...
<style id="band-4-styles">
    .learnosity-report .lrn-report-table tr[data-custom_performance="4"] {
        background: #B0D6A0;
    }
    .learnosity-report .table-bordered tr[data-custom_performance="4"] .lrn-report-user::after {
...
<style id="band-3-styles">
    .learnosity-report .lrn-report-table tr[data-custom_performance="3"] {
        background: #F0F8ED;
    }
    .learnosity-report .table-bordered tr[data-custom_performance="3"] .lrn-report-user::after {
...
<style id="band-2-styles">
    .learnosity-report .lrn-report-table tr[data-custom_performance="2"] {
        background: #FFEDDB;
    }
    .learnosity-report .table-bordered tr[data-custom_performance="2"] .lrn-report-user::after {
...
<style id="band-1-styles">
    .learnosity-report .lrn-report-table tr[data-custom_performance="1"] {
        background: #FBE3E3;
    }
    .learnosity-report .table-bordered tr[data-custom_performance="1"] .lrn-report-user::after {
