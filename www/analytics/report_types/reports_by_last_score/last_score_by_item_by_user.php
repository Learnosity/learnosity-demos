...
?>
    ...
    <div class="jumbotron section">
        ...
        <div class="overview">
            <h2>Last Score By Item By User Report</h2>
            <p>Obtain the latest activity score with a break-down of its constituent items. Hover over items to see the fine grain score break-down. Names and scores can trigger onClick events to tie into other reports.</p>
        </div>
    </div>

    <div class="section pad-sml">
        <!-- Container for the reports api to load into -->
        <h4>Last Score By Item By User</h4>
        <div id="report">
        </div>
    </div>
