...
?>
    ...
    <div class="jumbotron section">
        ...
        <div class="overview">
            <h2>Last Score By Activity Report</h2>
            <p>Obtain the latest activity scores for a particular student, represented by either a progress bar (shown), or a numeric result. Hover over student scores to gather a meaningful score breakdown. Activities and scores can trigger onClick events to tie into other reports.</p>
        </div>
    </div>

    <div class="section pad-sml">
        <!-- Container for the reports api to load into -->
        <h4>Last Score By Activity</h4>
        <div id="report">
        </div>
    </div>
