...
?>
    ...
    <div class="jumbotron section">
        ...
        <div class="overview">
            <h2>Sessions List By Item Report</h2>
            <p>Get a quick glimpse of the latest sessions with a score break-down for each item per session. Names can trigger onClick events to tie into other reports. Hover over items to see the fine grain score break-down.</p>
        </div>
    </div>

    <div class="section pad-sml">
        <!-- Container for the reports api to load into -->
        <h4>Sessions List By Item</h4>
        <div id="report"></div>
    </div>
