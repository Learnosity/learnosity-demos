...
$request = array(
    ...
    'config'         => array(
        ...
        'configuration'       => array(
            'ondiscard_redirect_url' => './assessment_2.php?user_id=' . htmlspecialchars($_GET['user_id'], ENT_QUOTES),
            'onsubmit_redirect_url' => './assessment_2.php?user_id=' . htmlspecialchars($_GET['user_id'], ENT_QUOTES),
            'onsave_redirect_url'   => './assessment_2.php?user_id=' . htmlspecialchars($_GET['user_id'], ENT_QUOTES),
            'events'                => true
        )
    )
);
