...
$endpoint = "$URL/sessions/responses/scores";
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="tab-request-form-<?php echo $resource; ?>" role="tabpanel" aria-labelledby="tab-request-form-<?php echo $resource; ?>-tab" tabindex="0">
        <form method="post" id="frm-data-api-<?php echo $resource; ?>" data-resource="<?php echo $resource; ?>">
            ...
            <div class="form-group row">
                <label class="col-md-2 col-form-label">activity(s)</label>
                <div class="col-md-10">
                    <input type="text" class="form-control" id="api-activity_id" data-type="array" value="">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-2 col-form-label">session(s)</label>
                <div class="col-md-10">
                    <input type="text" class="form-control" id="api-session_id" data-type="array" value="">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-2 col-form-label">user(s)</label>
                <div class="col-md-10">
            ...
            <div class="form-group row">
                <label class="col-md-2 col-form-label">
                    ...
                    <span class="bi bi-question-circle-fill"
                        ...
                        title="A unix timestamp or ISO 8601 datetime string, indicating a minimum point in time from when to return values." tabindex="0">
                    </span>
                </label>
                <div class="col-md-2">
            ...
            <div class="form-group row">
                <label class="col-md-2 col-form-label">
                    ...
                    <span class="bi bi-question-circle-fill"
                        data-bs-toggle="tooltip"
                        data-bs-placement="right"
                        title="A unix timestamp or ISO 8601 datetime string, indicating a maximum point in time to return values." tabindex="0">
                    </span>
                </label>
                <div class="col-md-2">
           ...
           <div class="form-group row">
                <label class="col-md-2 col-form-label">
                    ...
                    <span class="bi bi-question-circle-fill"
                        data-bs-toggle="tooltip"
                        data-bs-placement="right"
                        title="The 'next' value may be returned from an initial call to the Data API. Use it to retrieve the next pageset of results if there are any." tabindex="0">
                    </span>
                </label>
                <div class="col-md-4">
