        ...
        var callbacks = {
            readyListener: function () {
                ...
                itemsApp.assessApp().questionsApp().submit = function (settings) {
                    ...
                    if (!document.getElementById('alert-submit-error') && submitNumber < 3) {
                        document.querySelector('#test-save-submit .modal-dialog').insertAdjacentHTML(
                            'beforeend',
                    ...
                    if (submitNumber >= 3) {
                        const alertEl = document.getElementById('alert-submit-error');
                        if (alertEl) {
