...
if (isset($_GET['state']) && $_GET['state'] === 'review') {
    $state =  'review';
    $uniqueResponseIdSuffix = htmlspecialchars($_GET['uniqueResponseIdSuffix'], ENT_QUOTES);
} else {
    $state =  'initial';
        ...
        },
        {
            ...
            "areas":[
                [
                    ...
                    {
                        "x":38.25,
                        "y":16.554054054054053
                    },
                    {
                        "x":44.25,
                        "y":10.405405405405405
                    },
                    {
                        "x":46.25,
                        "y":3.3108108108108105
                    },
                    {
                        "x":37.75,
                        "y":1.8918918918918917
                    },
                    {
                        "x":31.5,
                        "y":1.8918918918918917
                    ...
                    {
                        "x":2.75,
                        "y":15.135135135135133
                    }
                ],
                [
                    {
                        "x":46,
                        "y":31.216216216216214
                    },
                    {
                        "x":42.75,
                        "y":33.108108108108105
                    },
                    {
                        "x":40.75,
                        "y":40.202702702702695
                    ...
                    {
                        "x":56.99999999999999,
                        "y":35.945945945945944
                    },
                    {
                        "x":53.75,
                        "y":33.581081081081074
                    },
                    {
                        "x":49.75,
                        "y":31.689189189189186
                    }
                ],
                [
                    {
...
<div class="jumbotron section">
    <div class="pull-right toolbar">
        <ul class="list-inline">
            ...
            <li data-toggle="tooltip" data-original-title="Visit the documentation"><a href="https://docs.learnosity.com/assessment/questions/questiontypes" title="Documentation"><span class="glyphicon glyphicon-book"></span></a></li>
        </ul>
    </div>
...
<div class="section">
    ...
    <div class="row">
        <div class="col-md-8">
            <h3 id="q18">Hot Spot</h3>
            <p>Click the continent with a population above <strong>1 billion.</strong></p>
