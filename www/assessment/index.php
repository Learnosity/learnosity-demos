...
<div class="jumbotron section index">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Build Pre-Written Fixed Form Assessments</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Embed Formative Assessment Questions into Editorial Content</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Generate Just-in-Time Fixed Form Assessments</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Branching Assessments</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Generate Item Adaptive (Rasch Model) Assessments</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Build Testlet Adaptive Assessments</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Fixed Form Assessments with Sections</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Using Dynamic Content And "Try Again" in Assessments</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Delivering STEM Assessments</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Offer Accessibility Controls and Assistive Tools</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Question Hints & Worked Solutions</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Display Distractor Rationale</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Allow Students to Preview Assessment Content</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Lock Questions to Prevent Further Edits</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Restrict Responses and Navigation</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Index Assessment Questions</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Provide Advanced Audio Features</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Use Your Existing MathJax Instance for Math Rendering</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Customize the Assessment Player UI</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Bind to Items API Events</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Enable Annotations for Student Use</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Right-to-Left Language Support</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Handling Submission Failures and Preserving Responses</h3>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Multi Language Support (i18n and l10n)</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Reset Learner Responses</h3>
                </div>
                <div class="card-body">
