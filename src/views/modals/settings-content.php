                        ...
                        <div class="panel-body">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="show_intro" class="col-sm-6 control-label">Show Intro Item</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="navigation[show_intro]" value="true"<?php if (isset($nav['show_intro']) && $nav['show_intro'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="navigation[show_intro]" value="false"<?php if (isset($nav['show_intro']) && $nav['show_intro'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="show_outro" class="col-sm-6 control-label">Show Outro Item</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="navigation[show_outro]" value="true"<?php if (isset($nav['show_outro']) && $nav['show_outro'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="navigation[show_outro]" value="false"<?php if (isset($nav['show_outro']) && $nav['show_outro'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="radio" name="navigation[show_calculator][use_calculator]" value="true"<?php if (isset($nav['show_calculator']) && $nav['show_calculator'] !== false) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="navigation[show_calculator][use_calculator]" value="false"<?php if (isset($nav['show_calculator']) == false || $nav['show_calculator'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="warning_on_change" class="col-sm-6 control-label">Show warning if question(s) not attempted</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="radio" name="navigation[scroll_to_test]" value="false"<?php if (isset($nav['scroll_to_test']) && $nav['scroll_to_test'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="radio" name="navigation[scroll_to_top]" value="false"<?php if (isset($nav['scroll_to_top']) && $nav['scroll_to_top'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="exit_securebrowser" class="col-sm-6 control-label">Exit Secure Browser</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="navigation[exit_securebrowser]" value="true"<?php if (isset($nav['exit_securebrowser']) && $nav['exit_securebrowser'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="navigation[exit_securebrowser]" value="false"<?php if (isset($nav['exit_securebrowser']) && $nav['exit_securebrowser'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="dynamic" class="col-sm-6 control-label">Dynamic</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="configuration[dynamic]" value="true"<?php if (isset($con['configuration']['dynamic']) && $con['configuration']['dynamic'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="configuration[dynamic]" value="false"<?php if (isset($con['configuration']['dynamic']) && $con['configuration']['dynamic'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="swipe" class="col-sm-6 control-label">Swipe</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="configuration[swipe]" value="true"<?php if (isset($con['configuration']['swipe']) && $con['configuration']['swipe'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="configuration[swipe]" value="false"<?php if (isset($con['configuration']['swipe']) && $con['configuration']['swipe'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="configuration[events]" class="col-sm-6 control-label">Events API</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="configuration[events]" value="true"<?php if (isset($con['configuration']['events']) && $con['configuration']['events'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="configuration[events]" value="false"<?php if (isset($con['configuration']['events']) && $con['configuration']['events'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                         <input type="radio" name="configuration[idle_timeout][use_idle_timeout]" value="true"<?php if (isset($con['configuration']['idle_timeout']) &&  $con['configuration']['idle_timeout'] !== false) { echo ' checked'; }; ?>> True
                                         <input type="radio" name="configuration[idle_timeout][use_idle_timeout]" value="false"<?php if (isset($con['configuration']['idle_timeout']) === false || $con['configuration']['idle_timeout'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                         <input type="radio" name="navigation[auto_save][use_auto_save]" value="true"<?php if (isset($nav['auto_save']) && $nav['auto_save'] !== false) { echo ' checked'; }; ?>> True
                                         <input type="radio" name="navigation[auto_save][use_auto_save]" value="false"<?php if (isset($nav['auto_save']) === false || $nav['auto_save'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="ui" class="col-sm-6 control-label">UI Indicator</label>
                                    <div class="col-sm-6">
                                        <input type="radio" name="navigation[auto_save][ui]" value="true"<?php if (isset($nav['auto_save']['ui']) && $nav['auto_save']['ui'] === true) { echo ' checked'; }; ?>> True
                                        <input type="radio" name="navigation[auto_save][ui]" value="false"<?php if (isset($nav['auto_save']['ui']) && $nav['auto_save']['ui'] === false) { echo ' checked'; }; ?>> False
                                    </div>
                                </div>
                                <div class="form-group">
