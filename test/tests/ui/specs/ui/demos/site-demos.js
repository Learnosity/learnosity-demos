...
describe('site-demos', function () {
        ...
        dataItems = [ 
            ...
            ['Demos', 'Authoring', 'Author API', 'Item List – Read Only', 'Demo'],
            ...
            // Assess API
            ['Demos', 'Assessment', 'Assess API', 'Use our Assessment Layer', 'Demo'],
            // Reports API
